...
from utils_splitfed_cheng_HAM_FG import (get_loaders, eval, get_loaders_test, test)
...
def main():
    ...
    global_codec1_fed = Cheng2020Attention(N=64).to(device)
    global_codec2_fed = Cheng2020Attention(N=64).to(device)
            ...
            for epoch in range(args.local_ep):
                ...
                if cl_idx == 1:  # C1---------------------------------------------------------------C1 local training & validation--------------------------------------------------------------------------------------------------------------------
                    ...
                    train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1= train(
                        train_loader, local_model1, local_model2, local_model3, comp_model1, comp_model2, comp_model3, comp_model4, optimizer1,optimizer2, optimizer3, comp_op1, comp_op2, comp_op3,comp_op4,loss_fn)
