...
from utils_splitfed_cheng2020_FG_attn_2 import (get_loaders, eval, get_loaders_test, test)
...
output_file = "/local-output_file = LOCATION_TO_OUTPUT_FILE
...
def train(train_loader, local_model1, local_model2, local_model3,comp_model1, comp_model2,comp_model3, comp_model4, optimizer1, optimizer2, optimizer3,comp_op1,comp_op2,comp_op3,comp_op4, loss_fn):
    ...
    for batch_idx, (data, targets) in enumerate(loop):
        ...
        S3_totloss.backward(retain_graph=True)       #backpropagates the loss due to compression errors through the BE model         
        #predictions2.backward(x_hat3,retain_graph=True) #passing the gradients from the decompressed gradients
        optimizer2.step()
