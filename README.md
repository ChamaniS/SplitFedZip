...
Split-Federated(splitFed) learning [(#reference-1)] is an innovative approach that combines the strengths of federated learning (FL)[2](#reference-2) and split learning (SL)[3](#reference-3).
