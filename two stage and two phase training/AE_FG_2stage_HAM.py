...
from utils_splitfed_customAE_FG_HAM_2stagephase import (get_loaders, eval, get_loaders_test, test)
import matplotlib as plt
import segmentation_models_pytorch as smp
from sklearn.metrics import jaccard_score
from options6 import args_parser
...
pretrained_F = LOCATION_TO_PRETRAINED_DATA_FOLDER
...
# client 1
TRAIN_IMG_DIR_C1 = dataDir + "./client_1/train_img/"
TRAIN_MASK_DIR_C1 = dataDir + "./client_1/train_mask/"
VAL_IMG_DIR_C1 = dataDir + "./client_1/test_img/"
VAL_MASK_DIR_C1 = dataDir + "./client_1/test_mask/"

# client 2
TRAIN_IMG_DIR_C2 = dataDir + "./client_2/train_img/"
TRAIN_MASK_DIR_C2 = dataDir + "./client_2/train_mask/"
VAL_IMG_DIR_C2 = dataDir + "./client_2/test_img/"
VAL_MASK_DIR_C2 = dataDir + "./client_2/test_mask/"

# client 3
TRAIN_IMG_DIR_C3 = dataDir + "./client_3/train_img/"
TRAIN_MASK_DIR_C3 = dataDir + "./client_3/train_mask/"
VAL_IMG_DIR_C3 = dataDir + "./client_3/test_img/"
VAL_MASK_DIR_C3 = dataDir + "./client_3/test_mask/"

# client 4
TRAIN_IMG_DIR_C4 = dataDir + "./client_4/train_img/"
TRAIN_MASK_DIR_C4 = dataDir + "./client_4/train_mask/"
VAL_IMG_DIR_C4 = dataDir + "./client_4/test_img/"
VAL_MASK_DIR_C4 = dataDir + "./client_4/test_mask/"

# client 5
TRAIN_IMG_DIR_C5 = dataDir + "./client_5/train_img/"
TRAIN_MASK_DIR_C5 = dataDir + "./client_5/train_mask/"
VAL_IMG_DIR_C5 = dataDir + "./client_5/test_img/"
VAL_MASK_DIR_C5 = dataDir + "./client_5/test_mask/"

TEST_IMG_DIR = dataDir + "./mutual_img/"
TEST_MASK_DIR = dataDir + "./mutual_mask/"

def train(train_loader, local_model1, local_model2, local_model3,comp_model1, comp_model2,comp_model3, comp_model4, optimizer1, optimizer2, optimizer3,comp_op1,comp_op2,comp_op3,comp_op4, loss_fn):
    #local_model1.train()
    #local_model2.train()
    #local_model3.train()
    #comp_model1.train()
    #comp_model2.train()
    for param in comp_model1.parameters():
        param.requires_grad = False
    for param in comp_model2.parameters():
        param.requires_grad = False
...
def main():
    ...
    local_model1_C1 = copy.deepcopy(global_model1_fed)
    local_model1_C2 = copy.deepcopy(global_model1_fed)
    local_model1_C3 = copy.deepcopy(global_model1_fed)
    local_model1_C4 = copy.deepcopy(global_model1_fed)
    local_model1_C5 = copy.deepcopy(global_model1_fed)
    local_model1_C1.load_state_dict(torch.load(pretrained_F + './C1M1_localcheckpoint.pth'))
    local_model1_C2.load_state_dict(torch.load(pretrained_F + './C2M1_localcheckpoint.pth'))
    local_model1_C3.load_state_dict(torch.load(pretrained_F + './C3M1_localcheckpoint.pth'))
    local_model1_C4.load_state_dict(torch.load(pretrained_F + './C4M1_localcheckpoint.pth'))
    local_model1_C5.load_state_dict(torch.load(pretrained_F + './C5M1_localcheckpoint.pth'))
    local_model2_C1 = copy.deepcopy(global_model2_fed)
    local_model2_C2 = copy.deepcopy(global_model2_fed)
    local_model2_C3 = copy.deepcopy(global_model2_fed)
    local_model2_C4 = copy.deepcopy(global_model2_fed)
    local_model2_C5 = copy.deepcopy(global_model2_fed)
    local_model2_C1.load_state_dict(torch.load(pretrained_F + './C1M2_localcheckpoint.pth'))
    local_model2_C2.load_state_dict(torch.load(pretrained_F + './C2M2_localcheckpoint.pth'))
    local_model2_C3.load_state_dict(torch.load(pretrained_F + './C3M2_localcheckpoint.pth'))
    local_model2_C4.load_state_dict(torch.load(pretrained_F + './C4M2_localcheckpoint.pth'))
    local_model2_C5.load_state_dict(torch.load(pretrained_F + './C5M2_localcheckpoint.pth'))            
    local_model3_C1 = copy.deepcopy(global_model3_fed)
    local_model3_C2 = copy.deepcopy(global_model3_fed)
    local_model3_C3 = copy.deepcopy(global_model3_fed)
    local_model3_C4 = copy.deepcopy(global_model3_fed)
    local_model3_C5 = copy.deepcopy(global_model3_fed)
    local_model3_C1.load_state_dict(torch.load(pretrained_F + './C1M3_localcheckpoint.pth'))
    local_model3_C2.load_state_dict(torch.load(pretrained_F + './C2M3_localcheckpoint.pth'))
    local_model3_C3.load_state_dict(torch.load(pretrained_F + './C3M3_localcheckpoint.pth'))
    local_model3_C4.load_state_dict(torch.load(pretrained_F + './C4M3_localcheckpoint.pth'))
    local_model3_C5.load_state_dict(torch.load(pretrained_F + './C5M3_localcheckpoint.pth'))

    global_codec1_fed = COMP_NW_FE().to(device)
    global_codec2_fed = COMP_NW_FE().to(device)
    global_codec3_fed = COMP_NW_FE().to(device)
    global_codec4_fed = COMP_NW_FE().to(device) 

    comp_model1_C1 = copy.deepcopy(global_codec1_fed)
    comp_model1_C2 = copy.deepcopy(global_codec1_fed)
    comp_model1_C3 = copy.deepcopy(global_codec1_fed)
    comp_model1_C4 = copy.deepcopy(global_codec1_fed)
    comp_model1_C5 = copy.deepcopy(global_codec1_fed)
    comp_model2_C1 = copy.deepcopy(global_codec2_fed)
    comp_model2_C2 = copy.deepcopy(global_codec2_fed)
    comp_model2_C3 = copy.deepcopy(global_codec2_fed)
    comp_model2_C4 = copy.deepcopy(global_codec2_fed)
    comp_model2_C5 = copy.deepcopy(global_codec2_fed)
    comp_model1_t = copy.deepcopy(global_codec1_fed) 
    comp_model2_t = copy.deepcopy(global_codec2_fed)
    
    comp_model3_C1 = copy.deepcopy(global_codec3_fed)
    comp_model3_C2 = copy.deepcopy(global_codec3_fed)
    comp_model3_C3 = copy.deepcopy(global_codec3_fed)
    comp_model3_C4 = copy.deepcopy(global_codec3_fed)
    comp_model3_C5 = copy.deepcopy(global_codec3_fed)
    comp_model4_C1 = copy.deepcopy(global_codec4_fed)
    comp_model4_C2 = copy.deepcopy(global_codec4_fed)
    comp_model4_C3 = copy.deepcopy(global_codec4_fed)
    comp_model4_C4 = copy.deepcopy(global_codec4_fed)
    comp_model4_C5 = copy.deepcopy(global_codec4_fed)
    comp_model3_t = copy.deepcopy(global_codec3_fed) 
    comp_model4_t = copy.deepcopy(global_codec4_fed)    
    
    
    comp_model1_C1.load_state_dict(torch.load(pretrained_F + './C1M1_codeccheckpoint.pth'))
    comp_model1_C2.load_state_dict(torch.load(pretrained_F + './C2M1_codeccheckpoint.pth'))
    comp_model1_C3.load_state_dict(torch.load(pretrained_F + './C3M1_codeccheckpoint.pth'))
    comp_model1_C4.load_state_dict(torch.load(pretrained_F + './C4M1_codeccheckpoint.pth'))
    comp_model1_C5.load_state_dict(torch.load(pretrained_F + './C5M1_codeccheckpoint.pth'))
    comp_model2_C1.load_state_dict(torch.load(pretrained_F + './C1M2_codeccheckpoint.pth'))
    comp_model2_C2.load_state_dict(torch.load(pretrained_F + './C2M2_codeccheckpoint.pth'))
    comp_model2_C3.load_state_dict(torch.load(pretrained_F + './C3M2_codeccheckpoint.pth'))
    comp_model2_C4.load_state_dict(torch.load(pretrained_F + './C4M2_codeccheckpoint.pth'))
    comp_model2_C5.load_state_dict(torch.load(pretrained_F + './C5M2_codeccheckpoint.pth'))
    comp_model1_t.load_state_dict(torch.load(pretrained_F + './M1_codecglobalcheckpoint.pth'))
    comp_model2_t.load_state_dict(torch.load(pretrained_F + './M2_codecglobalcheckpoint.pth'))
    comp_model3_C1.load_state_dict(torch.load(pretrained_F + './C1M3_codeccheckpoint.pth'))
    comp_model3_C2.load_state_dict(torch.load(pretrained_F + './C2M3_codeccheckpoint.pth'))
    comp_model3_C3.load_state_dict(torch.load(pretrained_F + './C3M3_codeccheckpoint.pth'))
    comp_model3_C4.load_state_dict(torch.load(pretrained_F + './C4M3_codeccheckpoint.pth'))
    comp_model3_C5.load_state_dict(torch.load(pretrained_F + './C5M3_codeccheckpoint.pth'))
    comp_model4_C1.load_state_dict(torch.load(pretrained_F + './C1M4_codeccheckpoint.pth'))
    comp_model4_C2.load_state_dict(torch.load(pretrained_F + './C2M4_codeccheckpoint.pth'))
    comp_model4_C3.load_state_dict(torch.load(pretrained_F + './C3M4_codeccheckpoint.pth'))
    comp_model4_C4.load_state_dict(torch.load(pretrained_F + './C4M4_codeccheckpoint.pth'))
    comp_model4_C5.load_state_dict(torch.load(pretrained_F + './C5M4_codeccheckpoint.pth'))
    comp_model3_t.load_state_dict(torch.load(pretrained_F + './M3_codecglobalcheckpoint.pth'))
    comp_model4_t.load_state_dict(torch.load(pretrained_F + './M4_codecglobalcheckpoint.pth'))
    ...
    for com_round in (range(args.rounds)):
        ...
        for idx in idxs_users:
            ...
            optimizer1_C1 = optim.Adam(local_model1_C1.parameters(), lr=LEARNING_RATE)
            optimizer1_C2 = optim.Adam(local_model1_C2.parameters(), lr=LEARNING_RATE) 
            optimizer1_C3 = optim.Adam(local_model1_C3.parameters(), lr=LEARNING_RATE)
            optimizer1_C4 = optim.Adam(local_model1_C4.parameters(), lr=LEARNING_RATE)
            optimizer1_C5 = optim.Adam(local_model1_C5.parameters(), lr=LEARNING_RATE)
            optimizer2_C1 = optim.Adam(local_model2_C1.parameters(), lr=LEARNING_RATE)
            optimizer2_C2 = optim.Adam(local_model2_C2.parameters(), lr=LEARNING_RATE)
            optimizer2_C3 = optim.Adam(local_model2_C3.parameters(), lr=LEARNING_RATE)
            optimizer2_C4 = optim.Adam(local_model2_C4.parameters(), lr=LEARNING_RATE)
            optimizer2_C5 = optim.Adam(local_model2_C5.parameters(), lr=LEARNING_RATE)
            optimizer3_C1 = optim.Adam(local_model3_C1.parameters(), lr=LEARNING_RATE)
            optimizer3_C2 = optim.Adam(local_model3_C2.parameters(), lr=LEARNING_RATE)
            optimizer3_C3 = optim.Adam(local_model3_C3.parameters(), lr=LEARNING_RATE)
            optimizer3_C4 = optim.Adam(local_model3_C4.parameters(), lr=LEARNING_RATE)
            optimizer3_C5 = optim.Adam(local_model3_C5.parameters(), lr=LEARNING_RATE) 
            
            comp_op1_C1 = optim.Adam(comp_model1_C1.parameters(), lr=LEARNING_RATE)
            comp_op1_C2 = optim.Adam(comp_model1_C2.parameters(), lr=LEARNING_RATE)
            comp_op1_C3 = optim.Adam(comp_model1_C3.parameters(), lr=LEARNING_RATE)
            comp_op1_C4 = optim.Adam(comp_model1_C4.parameters(), lr=LEARNING_RATE)  
            comp_op1_C5 = optim.Adam(comp_model1_C5.parameters(), lr=LEARNING_RATE)       
            
            comp_op2_C1 = optim.Adam(comp_model2_C1.parameters(), lr=LEARNING_RATE)
            comp_op2_C2 = optim.Adam(comp_model2_C2.parameters(), lr=LEARNING_RATE)
            comp_op2_C3 = optim.Adam(comp_model2_C3.parameters(), lr=LEARNING_RATE)
            comp_op2_C4 = optim.Adam(comp_model2_C4.parameters(), lr=LEARNING_RATE)  
            comp_op2_C5 = optim.Adam(comp_model2_C5.parameters(), lr=LEARNING_RATE) 
            
            comp_op3_C1 = optim.Adam(comp_model3_C1.parameters(), lr=LEARNING_RATE)
            comp_op3_C2 = optim.Adam(comp_model3_C2.parameters(), lr=LEARNING_RATE)
            comp_op3_C3 = optim.Adam(comp_model3_C3.parameters(), lr=LEARNING_RATE)
            comp_op3_C4 = optim.Adam(comp_model3_C4.parameters(), lr=LEARNING_RATE)  
            comp_op3_C5 = optim.Adam(comp_model3_C5.parameters(), lr=LEARNING_RATE)                        

            comp_op4_C1 = optim.Adam(comp_model4_C1.parameters(), lr=LEARNING_RATE)
            comp_op4_C2 = optim.Adam(comp_model4_C2.parameters(), lr=LEARNING_RATE)
            comp_op4_C3 = optim.Adam(comp_model4_C3.parameters(), lr=LEARNING_RATE)
            comp_op4_C4 = optim.Adam(comp_model4_C4.parameters(), lr=LEARNING_RATE)  
            comp_op4_C5 = optim.Adam(comp_model4_C5.parameters(), lr=LEARNING_RATE) 
            ...
            for epoch in range(args.local_ep):
                ...
                if cl_idx == 1:  # C1---------------------------------------------------------------C1 local training & validation--------------------------------------------------------------------------------------------------------------------
                    ...
                    train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1= train(
                        train_loader, local_model1_C1, local_model2_C1, local_model3_C1, comp_model1_C1, comp_model2_C1, comp_model3_C1, comp_model4_C1, optimizer1_C1,optimizer2_C1, optimizer3_C1, comp_op1_C1, comp_op2_C1, comp_op3_C1,comp_op4_C1,loss_fn)
                    ...
                    val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1 = eval(
                        val_loader, local_model1_C1, local_model2_C1, local_model3_C1, comp_model1_C1, comp_model2_C1, loss_fn, folder)
                    ...
                    if least_lossC1 > val_epoch_loss:
                        ...
                        torch.save(local_model1_C1.state_dict(),save_F + './Fed_Avg/Checkpoints/C1M1_localcheckpoint.pth')
                        torch.save(local_model2_C1.state_dict(),save_F + './Fed_Avg/Checkpoints/C1M2_localcheckpoint.pth')
                        torch.save(local_model3_C1.state_dict(),save_F + './Fed_Avg/Checkpoints/C1M3_localcheckpoint.pth')
                        print('C1localmodel saved')    
                        torch.save(comp_model1_C1.state_dict(),save_F + './Fed_Avg/Checkpoints/C1M1_codeccheckpoint.pth')
                        torch.save(comp_model2_C1.state_dict(),save_F + './Fed_Avg/Checkpoints/C1M2_codeccheckpoint.pth')
                        torch.save(comp_model3_C1.state_dict(),save_F + './Fed_Avg/Checkpoints/C1M3_codeccheckpoint.pth')
                        torch.save(comp_model4_C1.state_dict(),save_F + './Fed_Avg/Checkpoints/C1M4_codeccheckpoint.pth')
                ...
                if cl_idx == 2:  # C2--------------------------------------------------------------C2 local training & validation--------------------------------------------------------------------------------------------------------------------
                    ...
                    train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1= train(
                        train_loader, local_model1_C2, local_model2_C2, local_model3_C2, comp_model1_C2, comp_model2_C2, comp_model3_C2, comp_model4_C2, optimizer1_C2,optimizer2_C2, optimizer3_C2, comp_op1_C2, comp_op2_C2, comp_op3_C2,comp_op4_C2,loss_fn)
                    print("Client", cl_idx, "local validating.........")
                    val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1= eval(
                        val_loader, local_model1_C2, local_model2_C2, local_model3_C2, comp_model1_C2, comp_model2_C2, loss_fn, folder)
                    ...
                    if least_lossC2 > val_epoch_loss:
                        ...
                        torch.save(local_model1_C2.state_dict(),save_F + './Fed_Avg/Checkpoints/C2M1_localcheckpoint.pth')
                        torch.save(local_model2_C2.state_dict(),save_F + './Fed_Avg/Checkpoints/C2M2_localcheckpoint.pth')
                        torch.save(local_model3_C2.state_dict(),save_F + './Fed_Avg/Checkpoints/C2M3_localcheckpoint.pth')
                        print('C2localmodel saved')
                        torch.save(comp_model1_C2.state_dict(),save_F + './Fed_Avg/Checkpoints/C2M1_codeccheckpoint.pth')
                        torch.save(comp_model2_C2.state_dict(),save_F + './Fed_Avg/Checkpoints/C2M2_codeccheckpoint.pth')
                        torch.save(comp_model3_C2.state_dict(),save_F + './Fed_Avg/Checkpoints/C2M3_codeccheckpoint.pth')
                        torch.save(comp_model4_C2.state_dict(),save_F + './Fed_Avg/Checkpoints/C2M4_codeccheckpoint.pth')
                ...
                if cl_idx == 3:  # C3--------------------------------------------------------------C3 local training & validation-----------------------------------------------------------------------------------------------------------
                    ...
                    train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1= train(
                        train_loader, local_model1_C3, local_model2_C3, local_model3_C3, comp_model1_C3, comp_model2_C3, comp_model3_C3, comp_model4_C3, optimizer1_C3,optimizer2_C3, optimizer3_C3, comp_op1_C3, comp_op2_C3, comp_op3_C3,comp_op4_C3,loss_fn)
                    print("Client", cl_idx, "local validating.........")
                    val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1= eval(
                        val_loader, local_model1_C3, local_model2_C3, local_model3_C3, comp_model1_C3, comp_model2_C3, loss_fn, folder)
                    ...
                    if least_lossC3 > val_epoch_loss:
                        ...
                        torch.save(local_model1_C3.state_dict(),save_F + './Fed_Avg/Checkpoints/C3M1_localcheckpoint.pth')
                        torch.save(local_model2_C3.state_dict(),save_F + './Fed_Avg/Checkpoints/C3M2_localcheckpoint.pth')
                        torch.save(local_model3_C3.state_dict(),save_F + './Fed_Avg/Checkpoints/C3M3_localcheckpoint.pth')
                        print('C3localmodel saved')
                        torch.save(comp_model1_C3.state_dict(),save_F + './Fed_Avg/Checkpoints/C3M1_codeccheckpoint.pth')
                        torch.save(comp_model2_C3.state_dict(),save_F + './Fed_Avg/Checkpoints/C3M2_codeccheckpoint.pth')
                        torch.save(comp_model3_C3.state_dict(),save_F + './Fed_Avg/Checkpoints/C3M3_codeccheckpoint.pth')
                        torch.save(comp_model4_C3.state_dict(),save_F + './Fed_Avg/Checkpoints/C3M4_codeccheckpoint.pth')
                ...
                if cl_idx == 4:  # C4--------------------------------------------------------------C4 local training & validation-----------------------------------------------------------------------------------------------------------
                    ...
                    train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1 = train(
                        train_loader, local_model1_C4, local_model2_C4, local_model3_C4, comp_model1_C4, comp_model2_C4, comp_model3_C4, comp_model4_C4, optimizer1_C4,optimizer2_C4, optimizer3_C4, comp_op1_C4, comp_op2_C4, comp_op3_C4,comp_op4_C4, loss_fn)
                    print("Client", cl_idx, "local validating.........")
                    val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1 = eval(
                        val_loader, local_model1_C4, local_model2_C4, local_model3_C4, comp_model1_C4, comp_model2_C4,  loss_fn, folder)
                    ...
                    if least_lossC4 > val_epoch_loss:
                        ...
                        torch.save(local_model1_C4.state_dict(),save_F + './Fed_Avg/Checkpoints/C4M1_localcheckpoint.pth')
                        torch.save(local_model2_C4.state_dict(),save_F + './Fed_Avg/Checkpoints/C4M2_localcheckpoint.pth')
                        torch.save(local_model3_C4.state_dict(),save_F + './Fed_Avg/Checkpoints/C4M3_localcheckpoint.pth')
                        print('C4localmodel saved')
                        torch.save(comp_model1_C4.state_dict(),save_F + './Fed_Avg/Checkpoints/C4M1_codeccheckpoint.pth')
                        torch.save(comp_model2_C4.state_dict(),save_F + './Fed_Avg/Checkpoints/C4M2_codeccheckpoint.pth')
                        torch.save(comp_model3_C4.state_dict(),save_F + './Fed_Avg/Checkpoints/C4M3_codeccheckpoint.pth')
                        torch.save(comp_model4_C4.state_dict(),save_F + './Fed_Avg/Checkpoints/C4M4_codeccheckpoint.pth')
                ...
                if cl_idx == 5:  # C5--------------------------------------------------------------C5 local training & validation-----------------------------------------------------------------------------------------------------------
                    ...
                    train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1= train(
                        train_loader, local_model1_C5, local_model2_C5, local_model3_C5, comp_model1_C5, comp_model2_C5, comp_model3_C5, comp_model4_C5,optimizer1_C5,optimizer2_C5, optimizer3_C5, comp_op1_C5, comp_op2_C5, comp_op3_C5,comp_op4_C5,loss_fn)
                    print("Client", cl_idx, "local validating.........")
                    val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1= eval(
                        val_loader, local_model1_C5, local_model2_C5, local_model3_C5, comp_model1_C5, comp_model2_C5,  loss_fn, folder)
                    ...
                    if least_lossC5 > val_epoch_loss:
                        ...
                        torch.save(local_model1_C5.state_dict(),save_F + './Fed_Avg/Checkpoints/C5M1_localcheckpoint.pth')
                        torch.save(local_model2_C5.state_dict(),save_F + './Fed_Avg/Checkpoints/C5M2_localcheckpoint.pth')
                        torch.save(local_model3_C5.state_dict(),save_F + './Fed_Avg/Checkpoints/C5M3_localcheckpoint.pth')
                        print('C5localmodel saved')
                        torch.save(comp_model1_C5.state_dict(),save_F + './Fed_Avg/Checkpoints/C5M1_codeccheckpoint.pth')
                        torch.save(comp_model2_C5.state_dict(),save_F + './Fed_Avg/Checkpoints/C5M2_codeccheckpoint.pth')
                        torch.save(comp_model3_C5.state_dict(),save_F + './Fed_Avg/Checkpoints/C5M3_codeccheckpoint.pth')
                        torch.save(comp_model4_C5.state_dict(),save_F + './Fed_Avg/Checkpoints/C5M4_codeccheckpoint.pth')
        ...
        print("Done")       
        #codecs
        C1M1codecbest = torch.load(save_F + './Fed_Avg/Checkpoints/C1M1_codeccheckpoint.pth')
        print("Done") 
        C2M1codecbest = torch.load(save_F + './Fed_Avg/Checkpoints/C2M1_codeccheckpoint.pth')
        print("Done")         
        C3M1codecbest = torch.load(save_F + './Fed_Avg/Checkpoints/C3M1_codeccheckpoint.pth')
        print("Done") 
        C4M1codecbest = torch.load(save_F + './Fed_Avg/Checkpoints/C4M1_codeccheckpoint.pth')
        print("Done") 
        C5M1codecbest = torch.load(save_F + './Fed_Avg/Checkpoints/C5M1_codeccheckpoint.pth')
        print("Done") 
        C1M2codecbest = torch.load(save_F + './Fed_Avg/Checkpoints/C1M2_codeccheckpoint.pth')
        print("Done") 
        C2M2codecbest = torch.load(save_F + './Fed_Avg/Checkpoints/C2M2_codeccheckpoint.pth')
        print("Done") 
        C3M2codecbest = torch.load(save_F + './Fed_Avg/Checkpoints/C3M2_codeccheckpoint.pth')
        print("Done") 
        C4M2codecbest = torch.load(save_F + './Fed_Avg/Checkpoints/C4M2_codeccheckpoint.pth')
        print("Done") 
        C5M2codecbest = torch.load(save_F + './Fed_Avg/Checkpoints/C5M2_codeccheckpoint.pth')        
        ...
        C1M1codecbest.update((x, y * D1) for x, y in C1M1codecbest.items())
        C2M1codecbest.update((x, y * D2) for x, y in C2M1codecbest.items())
        C3M1codecbest.update((x, y * D3) for x, y in C3M1codecbest.items())
        C4M1codecbest.update((x, y * D4) for x, y in C4M1codecbest.items())
        C5M1codecbest.update((x, y * D5) for x, y in C5M1codecbest.items())        
        C1M2codecbest.update((x, y * D1) for x, y in C1M2codecbest.items())
        C2M2codecbest.update((x, y * D2) for x, y in C2M2codecbest.items())
        C3M2codecbest.update((x, y * D3) for x, y in C3M2codecbest.items())
        C4M2codecbest.update((x, y * D4) for x, y in C4M2codecbest.items())
        C5M2codecbest.update((x, y * D5) for x, y in C5M2codecbest.items())
        ...
        M1_codec_dict = [C1M1codecbest, C2M1codecbest, C3M1codecbest, C4M1codecbest, C5M1codecbest]
        M2_codec_dict = [C1M2codecbest, C2M2codecbest, C3M2codecbest, C4M2codecbest, C5M2codecbest]
            ...
            for epoch in range(args.val_global_ep):
                ...
                if cl_idx == 1:
                    g_val_epoch_loss, g_val_epoch_acc, g_val_epoch_iouwithback, g_val_epoch_iounoback, g_valepoch_iou_class0, g_valepoch_iou_class1 = eval(
                        val_loader, global_model1_fed, global_model2_fed, global_model3_fed,global_codec1_fed, global_codec2_fed,  loss_fn, folder)
        ...
        for epoch in range(args.val_global_ep):
            ...
            test_epoch_loss, test_epoch_acc, test_epoch_accwithback, test_epoch_accnoback = test(
                ...
                M1_test,
                M2_test,
                M3_test,M1codec_test, M2codec_test,
                loss_fn, test_folder)
            print('\n')
            print(
