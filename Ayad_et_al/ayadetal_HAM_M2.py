...
def train(train_loader, local_model1, local_model2, local_model3,comp_model1, comp_model2, optimizer1, optimizer2, optimizer3,comp_op1,comp_op2, loss_fn,round_idx):
            ...
            for epoch in range(args.local_ep):
                ...
                if cl_idx == 1:  # C1---------------------------------------------------------------C1 local training & validation--------------------------------------------------------------------------------------------------------------------
                    ...
                    train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1= train(
                        train_loader, local_model1, local_model2, local_model3, comp_model1, comp_model2, optimizer1,optimizer2, optimizer3, comp_op1, comp_op2, loss_fn,round_idx)
                    ...
                    if least_lossC1 > val_epoch_loss:
                        ...
                        #torch.save(optimizer1.state_dict(),save_F + './Fed_Avg/Checkpoints/optimizer1_C1.pth')
                        #torch.save(optimizer2.state_dict(),save_F + './Fed_Avg/Checkpoints/optimizer2_C1.pth')
                        #torch.save(optimizer3.state_dict(),save_F + './Fed_Avg/Checkpoints/optimizer3_C1.pth')                       
                ...
                if cl_idx == 2:  # C2--------------------------------------------------------------C2 local training & validation--------------------------------------------------------------------------------------------------------------------
                    ...
                    if least_lossC2 > val_epoch_loss:
                        ...
                        #torch.save(optimizer1.state_dict(),save_F + './Fed_Avg/Checkpoints/optimizer1_C2.pth')
                        #torch.save(optimizer2.state_dict(),save_F + './Fed_Avg/Checkpoints/optimizer2_C2.pth')
                        #torch.save(optimizer3.state_dict(),save_F + './Fed_Avg/Checkpoints/optimizer3_C2.pth')
                ...
                if cl_idx == 3:  # C3--------------------------------------------------------------C3 local training & validation-----------------------------------------------------------------------------------------------------------
                    ...
                    if least_lossC3 > val_epoch_loss:
                        ...
                        #torch.save(optimizer1.state_dict(),save_F + './Fed_Avg/Checkpoints/optimizer1_C3.pth')
                        #torch.save(optimizer2.state_dict(),save_F + './Fed_Avg/Checkpoints/optimizer2_C3.pth')
                        #torch.save(optimizer3.state_dict(),save_F + './Fed_Avg/Checkpoints/optimizer3_C3.pth')
                ...
                if cl_idx == 4:  # C4--------------------------------------------------------------C4 local training & validation-----------------------------------------------------------------------------------------------------------
                    ...
                    if least_lossC4 > val_epoch_loss:
                        ...
                        #torch.save(optimizer1.state_dict(),save_F + './Fed_Avg/Checkpoints/optimizer1_C4.pth')
                        #torch.save(optimizer2.state_dict(),save_F + './Fed_Avg/Checkpoints/optimizer2_C4.pth')
                        #torch.save(optimizer3.state_dict(),save_F + './Fed_Avg/Checkpoints/optimizer3_C4.pth')
                ...
                if cl_idx == 5:  # C5--------------------------------------------------------------C5 local training & validation-----------------------------------------------------------------------------------------------------------
                    ...
                    if least_lossC5 > val_epoch_loss:
                        ...
                        #torch.save(optimizer1.state_dict(),save_F + './Fed_Avg/Checkpoints/optimizer1_C5.pth')
                        #torch.save(optimizer2.state_dict(),save_F + './Fed_Avg/Checkpoints/optimizer2_C5.pth')
                        #torch.save(optimizer3.state_dict(),save_F + './Fed_Avg/Checkpoints/optimizer3_C5.pth')
