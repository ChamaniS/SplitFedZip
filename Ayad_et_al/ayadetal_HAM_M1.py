...
from ayadetal_utils import (get_loaders, eval, get_loaders_test, test)
...
TEST_IMG_DIR = "/home/csj5/Final_Data/HAM10K/mutual_img/"
TEST_MASK_DIR = "/home/csj5/Final_Data/HAM10K/mutual_mask/"

def train(train_loader, local_model1, local_model2, local_model3,comp_model1, comp_model2, optimizer1, optimizer2, optimizer3, loss_fn): 
    ...
    for batch_idx, (data, targets) in enumerate(loop):
        ...
        loss = dice_loss3 #since codecs are frozen now
        #print (loss.item())
        ...
        if (loss.item()>grad_thresh):
          predictions2.backward(grads3,retain_graph=True)
          #print(loss.item(),"passed")
          count=count+1
        else:
          #print(loss.item(),"Not passed")
          continue 
    ...
    for com_round in (range(args.rounds)):
            ...
            for epoch in range(args.local_ep):
                ...
                if cl_idx == 1:  # C1---------------------------------------------------------------C1 local training & validation--------------------------------------------------------------------------------------------------------------------
                    ...
                    train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1= train(
                        train_loader, local_model1_C1, local_model2_C1, local_model3_C1, comp_model1_C1, comp_model2_C1, optimizer1_C1,optimizer2_C1, optimizer3_C1, loss_fn)
                ...
                if cl_idx == 2:  # C2--------------------------------------------------------------C2 local training & validation--------------------------------------------------------------------------------------------------------------------
                    ...
                    train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1= train(
                        train_loader,local_model1_C2, local_model2_C2, local_model3_C2, comp_model1_C2, comp_model2_C2, optimizer1_C2,optimizer2_C2, optimizer3_C2, loss_fn)
                    #print("Client", cl_idx, "local validating.........")
                    val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1 = eval(
                ...
                if cl_idx == 3:  # C3--------------------------------------------------------------C3 local training & validation-----------------------------------------------------------------------------------------------------------
                    ...
                    train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1 = train(
                        train_loader, local_model1_C3, local_model2_C3, local_model3_C3, comp_model1_C3, comp_model2_C3, optimizer1_C3,optimizer2_C3, optimizer3_C3, loss_fn)
                    #print("Client", cl_idx, "local validating.........")
                    val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1= eval(
                ...
                if cl_idx == 4:  # C4--------------------------------------------------------------C4 local training & validation-----------------------------------------------------------------------------------------------------------
                    ...
                    train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1 = train(
                        train_loader, local_model1_C4, local_model2_C4, local_model3_C4, comp_model1_C4, comp_model2_C4, optimizer1_C4,optimizer2_C4, optimizer3_C4, loss_fn)
                    print("Client", cl_idx, "local validating.........")
                    val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1 = eval(
                ...
                if cl_idx == 5:  # C5--------------------------------------------------------------C5 local training & validation-----------------------------------------------------------------------------------------------------------
                    ...
                    train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1= train(
                        train_loader, local_model1_C5, local_model2_C5, local_model3_C5, comp_model1_C5, comp_model2_C5, optimizer1_C5,optimizer2_C5, optimizer3_C5, loss_fn)
                    print("Client", cl_idx, "local validating.........")
                    val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1= eval(
                ...
                #print(f"Training loss: {train_epoch_loss:.3f}, Training accuracy: {train_epoch_acc:.3f},Training iou Score with background: {trainepoch_iou_withbackground:.3f},Training iou Score without background: {trainepoch_iou_nobackground:.3f}")
                ...
                #print(f"Validating loss: {val_epoch_loss:.3f}, Validating accuracy: {val_epoch_acc:.3f},Validating iou Score with background: {valepoch_iou_withbackground:.3f},Validating iou Score without background: {valepoch_iou_nobackground:.3f}")
            ...
            for epoch in range(args.val_global_ep):
                ...
                if cl_idx == 1:
                    g_val_epoch_loss, g_val_epoch_acc, g_val_epoch_iouwithback, g_val_epoch_iounoback, g_valepoch_iou_class0, g_valepoch_iou_class1 = eval(
                        val_loader, global_model1_fed, global_model2_fed, global_model3_fed,comp_model1_t, comp_model2_t,  loss_fn, folder)
                ...
                #print(f"Global Validating loss: {g_val_epoch_loss:.3f}, Global Validating accuracy: {g_val_epoch_acc:.3f},Global Validating iou Score with background: {g_val_epoch_iouwithback:.3f},Global Validating iou Score without background: {g_val_epoch_iounoback:.3f}")
        ...
        for epoch in range(args.val_global_ep):
            ...
            test_epoch_loss, test_epoch_acc, test_epoch_accwithback, test_epoch_accnoback = test(
                ...
                M1_test,
                M2_test,
                M3_test,comp_model1_t, comp_model2_t,
                loss_fn, test_folder)
            print('\n')
            print(f"Testing loss: {test_epoch_loss:.3f}, Testing accuracy: {test_epoch_acc:.3f},Testing iou Score with background: {test_epoch_accwithback:.3f},Testing iou Score without background: {test_epoch_accnoback:.3f}")
